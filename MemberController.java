...
public class MemberController {
    ...
    public ResponseEntity<?> insertMember(@RequestBody Member params) {
        memberService.insertMember(params.getName());
    ...
    @PostMapping("/{id}/flowers/{flowerName}")
    public ResponseEntity<?> buyFlower(@PathVariable(name = "id") Long id,
                                       @PathVariable(name = "flowerName") String flowerName) {
        String result = memberService.buyFlower(id, flowerName);
